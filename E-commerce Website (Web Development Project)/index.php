        ...
        <div class="view" style="background-image: url('https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/8-col/img%282%29.jpg'); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="mask rgba-black-strong d-flex justify-content-center align-items-center">
            ...
            <div class="text-center white-text mx-5 wow fadeIn">
              <h1 class="mb-4">
                <strong>ENJOY 14 AUGUST WITH US</strong>
              </h1>

              <p>
                <strong>Best & Cheap Shoping</strong>
              </p>

              <p class="mb-4 d-none d-md-block">
                <strong>All products are avaiable with upto 50% off and all are branded.</strong>
              </p>

              <a class="btn btn-outline-white btn-lg">Start Shoping Today
              </a>
            </div>
            <!-- Content -->
      ...
      <div class="carousel-item">
        <div class="view" style="background-image: url('https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/8-col/img%283%29.jpg'); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="mask rgba-black-strong d-flex justify-content-center align-items-center">
            ...
            <div class="text-center white-text mx-5 wow fadeIn">
              <h1 class="mb-4">
                <strong>Largest Online Shopping in Pakistan</strong>
              </h1>

              <p>
                <strong>First E-Commerce store of Pakistan</strong>
              </p>

              <p class="mb-4 d-none d-md-block">
                <strong> Online Shop is offering original branded products with main conveniences of cash on delivery and free shipping countrywide.</strong>
              </p>
      ...
      <div class="carousel-item">
        <div class="view" style="background-image: url('https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/8-col/img%285%29.jpg'); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="mask rgba-black-strong d-flex justify-content-center align-items-center">
            ...
            <div class="text-center white-text mx-5 wow fadeIn">
              <h1 class="mb-4">
                <strong>New EID Collection</strong>
              </h1>
              ...
              <p class="mb-4 d-none d-md-block">
                <strong>DELIVERY ANYWHERE. GENUINE PRODUCTS</strong>
              </p>

              <a target="_blank" class="btn btn-outline-white btn-lg">SHOP NOW
              </a>
            </div>
            <!-- Content -->
